...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-leaf"></i> Technical Enviroment Complexcity Factor (ECF)</h2>
	...
	<div class="alert alert-success">
				...
				?>
				<p align="justify">
				Selain faktor kompleksitas teknis, faktor kompleksitas lingkugan (Enviromental Complexity Factor) juga digunakan dalam menentukan estimasi harga proyek. 
				Sama halnya dengan TCF, ECF ini juga ada pembobotan dari setiap faktor yang ada. 
				Jangkauan (range) pembobotann yang ada yaitu atara 0(nol) sampai 5
