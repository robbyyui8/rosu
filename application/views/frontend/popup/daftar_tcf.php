...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-tags"></i>  Daftar Indikator Kompleksitas Faktor Teknis</h2>
	...
	<div class="alert alert-success">
				...
				?>
				<p align="justify">
				Techinal complexity factor ini digunakan untuk melakukan estimasi terhadap  faktor-faktor teknis yang berdampak terhadap produktivitas  dari pengerjaan proyek. 
				Untuk setiap proyek, setiap faktor teknis dievaluasi dengan tim pengembang berdasaktan tingkat kompleksitasya. 
				Untuk penilaian terhadap tngkat kompleksitas dri setiap faktor, diberikan bobot dari 0 sampai 5.  
				Setelah itu, bobot yang ada tadi dikalikan dengan nilai masing-masing kompleksitas faktor.
				</p>
