...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-th-large"></i> Informasi Perhitungan UUCW</h2>
	...
	<div class="alert alert-success">
				...
				?>
				<p align="justify">
				Dalam UUCW ini, ada 3 kategori dalam menentukan use case, yaitu: simple, average, dan kompleks.
				Setiap use case dikategorikan dari jumlah sekenario/transaksi yang terkandung didalamnya. 
				Transaksi menurut, Ivar Jcobson, didefinisikan sebuah “round trip” dari pengguna kedalam system, 
				kemudian system kedalam pengguna. Sebuah transaksi akan seelsai jika system menunggu inputan baru/stimulus 
				baru
				</p>
