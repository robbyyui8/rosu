...
function makeAjaxCall(){
	...
	$.ajax({
		type: "post",
		url: "<?php echo base_url(); ?>log_estimasi/add_aw",
		cache: false,				
  ...
  <div class="box col-md-12">
    <div class="box-inner">
      <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-usd"></i>Form Tambah Log Aktor Weight <?php if(isset($edit)){ echo'<span class="label label-info">Edit</span>';} ?> </h2>
        <!--
          <div class="box-icon">
      ...
      <div class="box-content">
        ...
        <li>
		 ...
		 <li>
            <a href="<?php echo base_url();?>log_estimasi/form_tambah_log_aw">Tambah Log Actor Weight</a>
        </li>
    </ul>
