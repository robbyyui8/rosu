...
function makeAjaxCall(){
	...
	$.ajax({
		type: "post",
		url: "<?php echo base_url();?>log_estimasi/update_log_ucw/<?php echo $id_log_uc;?>",
		cache: false,				
  ...
  <div class="box col-md-12">
    <div class="box-inner">
      <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-usd"></i>Form Edit Log Use Case Weight <?php if(isset($edit)){ echo'<span class="label label-info">Edit</span>';} ?> </h2>
        <!--
          <div class="box-icon">
	  ...
	  <ul class="breadcrumb">
        ...
        <li>
		 ...
		 <li>
            <a href="<?php echo base_url();?>log_estimasi/edit_log_ucw/<?php echo $id_log_uc;?>">Edit Log Use Case Weight</a>
        </li>
    </ul>
     <label class="control-label"  for="selectError"><h3>Use Case Weight</h3></label>
		...
		<a  class="glyphicon glyphicon-question-sign" onclick="PopupCenterDual('<?php echo base_url(); ?>estimasi/popUCW','NIGRAPHIC','700','700');  " href="javascript:void(0);"></a>
				...
				<div class="form-group">
                    ...
                    <input type="text"  name="nama_uc"  value="<?php echo $nama_use_case; ?>"class="form-control" id="nama_uc" style="width:400px">
                </div>
				
				  <input type="hidden"  name="id_aplikasi"  value="<?php echo $id_aplikasi; ?>"class="form-control" id="nama_uc" style="width:400px">
				
				<div class="form-group " >
                        <label for="exampleInputEmail1">Jumlah Transaksi</label>
                        <input type="number" name="jum_transaksi" value="<?php echo $jum_transaksi; ?>"  min="0" class="form-control" id="jum_transaksi"  style="width:70px">
                    </div>
